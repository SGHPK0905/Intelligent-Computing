...
try:
    ...
    with col2:
        ...
        tab1, tab2, tab3, tab4 = st.tabs([
            "⏱️ Thời gian", "🌪️ Tốc độ vắt",
            "🌡️ Nhiệt độ",  "🧊 Mặt Cong 3D (Tương tác)"
        ])
        ...
        with tab4:
            ...
            st.caption("Góc nhìn: Tốc độ vắt phụ thuộc vào Độ nhạy vải và Mức dầu mỡ "
                       "(Các biến khác đóng băng theo Slider bên trái).")
            ...
            if st.button("🚀 Nhấn vào đây để render biểu đồ 3D", type="primary"):
                with st.spinner('Đang tính toán ma trận 2500 điểm dữ liệu...'):
                    ...
                    fig_3d = go.Figure(data=[go.Surface(
                        z=z_vals, x=x_vals, y=y_vals, colorscale='Viridis'
                    )])
    ...
    st.error(f"Hệ thống gặp lỗi nội suy: {e}\n\n"
             "Vui lòng kiểm tra lại thông số đầu vào hoặc Tập Luật (Fuzzy Holes)!")